...
Python wrapper for South Carolina school enrollment data.

This is a thin rpy2 wrapper around the [scschooldata](https://github.com/almartin82/scschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `scschooldata` R package installed
...
# In R:
# remotes::install_github("almartin82/scschooldata")

# Then install the Python package
pip install pyscschooldata
```
