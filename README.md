...
Fetch and analyze South Carolina school enrollment data from the South Carolina Department of Education (SCDE) in R or Python. **Over a decade of data** (2013-2025) for every school, district, and the state -- nearly 800,000 students across 80 districts.
...
**[Full documentation](https://almartin82.github.io/scschooldata/)** -- all 15 stories with interactive charts, getting-started guide, and complete function reference.
...
- [Enrollment trends](https://almartin82.github.io/scschooldata/articles/enrollment_hooks.html) -- 15 stories
- [Function reference](https://almartin82.github.io/scschooldata/reference/)
...
![Gender Balance in South Carolina's Largest Districts](https://almartin82.github.io/scschooldata/articles/enrollment_hooks_files/figure-html/gender-gap-chart-1.png)
